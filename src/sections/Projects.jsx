...
import { SiTailwindcss, SiVite, SiMysql, SiBootstrap, SiSupabase } from 'react-icons/si';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 justify-items-center w-full">
        ...
        <div className="flex flex-col items-center group w-full max-w-4xl">
          ...
          <p className="mt-4 text-[#ccd6f6] text-base px-4">
            CanDo es una aplicación diseñada para ayudarte a educar a tu perro con consejos prácticos y reales de educadores caninos. Combina un sistema de planes personalizados, seguimiento diario y recompensas visuales que te motivan a continuar.
            Su objetivo: mejorar la conducta de tu perro y fortalecer vuestro vínculo día a día.
          </p>
